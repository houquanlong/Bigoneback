...
<link type="text/css" rel="stylesheet" href="public/font/font-awesome.min.css"/>
<!--[if IE 7]>
<link href="public/font/font-awesome-ie7.min.css" rel="stylesheet" type="text/css" />
<![endif]-->
<!--[if IE 6]>
  ...
  <aside class="Hui-aside" style="">
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-user">
        ...
        <dd>
          <ul>
            <li><a _href="index.php?r=user/list" href="javascript:;">用户管理</a></li>
            <li><a _href="index.php?r=user/black" href="javascript:;">黑名单</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-comments">
      ...
      <dl id="menu-article">
        ...
        <dd>
          <ul>
            <li><a _href="article-class.html" href="javascript:void(0)"><分类管></分类管>理</a></li>
